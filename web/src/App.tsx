...
function ContextGauge({ liveSnapshot }: { liveSnapshot: WorkbenchSnapshotV1 | null }) {
  ...
  const hasLocalEstimate = Boolean(context && context.source === 'local_estimate' && context.estimated_tokens !== null)
  ...
  const progressPercent = hasServerUsage || hasLocalEstimate || !liveSnapshot ? Math.min((totalTokens / progressMax) * 100, 100) : 0
