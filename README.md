...
Claude Code 官方文档对照结论与保留差异见 [`docs/claude-code-review.md`](docs/claude-code-review.md)。对照后的安全加固批次（批次 1–4 已完成）见 [`docs/security-hardening.md`](docs/security-hardening.md)。对照 DeepSeek Harness 的运行时预设路线见 [`docs/runtime-profile.md`](docs/runtime-profile.md)。
