...
Claude Code 官方文档对照结论与保留差异见 [`docs/claude-code-review.md`](docs/claude-code-review.md)。对照后的安全加固批次（共享 denylist 已完成）见 [`docs/security-hardening.md`](docs/security-hardening.md)。
