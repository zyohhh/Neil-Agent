...
class ContextDto(WorkbenchDto):
    ...
    def from_tomography(cls, tomography: ContextTomography) -> ContextDto:
        ...
        largest = tomography.tool_results.largest[0] if tomography.tool_results.largest else None
    ...
    @classmethod
    def unavailable(cls, *, limit_tokens: int | None) -> ContextDto:
        """Return one bounded unavailable context projection."""

        return cls(source="unavailable", limit_tokens=limit_tokens)
